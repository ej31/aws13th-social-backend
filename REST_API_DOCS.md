...
| 필드 | 타입 | 필수 | 설명 |
| --- | --- | --- | --- |
| new_comment | string | O | 내가 작성했던 댓글에 내용을 수정합니다. |

**Request Example** 

```json
{
  "new_comment": "다시 생각해보니 내 말이 틀렸던 것 같다."
}
```
...
| 필드 | 타입 | 필수 | 설명 |
| --- | --- | --- | --- |
| new_title | string | X | 사용자는 자신이 작성한 게시물의 제목을 바꿀 수 있습니다. |
| new_content | string | X | 사용자는 자신이 작성한 게시물의 내용을 바꿀 수 있습니다. |

**Request Example** 

```json
{
  "new_title": "열심히 하는 개발자는 무조건 성공한다.",
  "new_content": "취업이 안되는 개발자는 열심히 안한 개발자다."
}
```
